...
total_adults = sum([guest['party_number_adults'] for guest in guests])
print(total_adults)
# Use a list comprehension to calculate the total number of child guests
total_children = sum([guest['party_number_children'] for guest in guests])

# Use a list comprehension to calculate the total number of guests
total_guests = sum([guest['party_number_adults'] + guest['party_number_children'] for guest in guests])

# Use a list comprehension to create a string of the guest's name in 
# title case and the total number of guests in the party
for guest in guests:
    print([f"{guest['guest_name'].title()} has {guest['party_number_adults'] + guest['party_number_children']} guests in their party."])